package com.mycompany.anexa.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.mycompany.anexa.service.EmailAlreadyUsedException ||
            ex instanceof com.mycompany.anexa.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.mycompany.anexa.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.mycompany.anexa");
    }
}
